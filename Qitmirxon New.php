...
error_reporting(0);
ob_start();
define('API_KEY', '869874064:AAG0Z_1RgDEhl2_2jkeE-cKxNqsfY8-lrA8');
$admin = "482219058"; 
...
[ 'inline_keyboard'=>[
                ...
                [['text'=>'✅Botga Kirish','url'=>'https://telegram.me/Qitmirxonbot'],], 
               ] ],
...
if($get =="member"){
  ...
  bot('sendmessage', [
   ...
   if($data == "reklamaqilish"){
      ...
      $in = "🕵*Do'stlaringizni taklif qilish uchun ssilka:*➡️ [https://telegram.me/Qitmirxonbot?start=$chat_id2]
...
if($text1 == "/start" or $text1 == "/start@Qitmirxonbot"){
...
'disable_web_page_preview'=>true,
  ...
  [["switch_inline_query"=>"@", 'text' => "🆔Sinab korish"],['text'=>'👥Guruhga qo‘shish','url'=>'telegram.me/Qitmirxonbot?startgroup=new']]
]   
]),
]);
}
...
['inline_keyboard' => [
  ...
  [['text'=>'👥Guruhga qo‘shish','url'=>'telegram.me/Qitmirxonbot?startgroup=new']]
]
]),
]);
}
...
[['text'=>'🔙Orqaga','callback_data'=>"foydali"],['text'=>'♻Tarqatish↗','url'=>'http://telegram.me/share/url?url=https://t.me/Qitmirxonbot']]
]
]),
]);
}
...
[['url' => 'https://telegram.me/Qitmirxonbot?startgroup=new', 'text' => "Guruhga Qo‘shish"],],
]
]),
]);
}
...
'reply_markup'=>json_encode(
['inline_keyboard' => [
[['text'=>'🔀Reklama','url'=>'https://telegram.me/Tg_groupsQitmirxonbot'],],
   [['text'=>'📡UZB RekN1','url'=>'https://telegram.me/GruppalaQitmirxonbot'],], 
    [['text'=>'😉Angiza bot','url'=>'https://telegram.me/Qitmirxonbot'],], 
...
if($text1 == "/buyruqlar" or $text1 == "/buyruqlar@Qitmirxonbot"){
if($cty == "supergroup" or $cty == "group"){
  bot('sendChatAction',['chat_id'=>$chat_id,'action'=>"typing"]);
$bs = bot('sendMessage',[
'chat_id'=>$chat_id,
...
if(mb_stripos($mtext,"/rasm" or $mtext,"/rasm2@Qitmirxonbot") !== false){ 
  bot('sendPhoto',[
       'chat_id'=>$chat_id,
        'photo'=>$photo,
        'parse_mode'=>'markdown',
...
/// YANGI KOD
if($text1 == "/sozlamalar" or $text1 == "/sozlamalar@Qitmirxonbot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
🌠Bu oy $buoy kundan iborat",
    ...
    if($text1 == "/admin" or $text == "/admin@Qitmirxonbot"){
      bot('sendmessage',[
        'chat_id'=>$chat_id,
...
//---------- @PHP_New ----------\\
if($text1 == "ro" or $text1 == "Ro" or $text1 == "RO" or $text1 == "/ro@Qitmirxonbot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($get =="administrator" or $get == "creator"){
  ...
  bot('sendmessage', [
    ...
    if($text1 == "Kick"  or  $text1 == "kick"  or $text1 == "/kick" or $text1 == "/kick@Qitmirxonbot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($get =="member"){
 ...
 if($text1 == "Addpm" or $text1 == "addpm" or $text1 == "/addpm@Qitmirxonbot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($get =="administrator" or $get == "creator"){
  ...
  bot('sendmessage',[
   ...
   if($text1 == "Delpm" or $text1 == "delpm" or $text1 == "/delpm@Qitmirxonbot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
bot('promoteChatMember',[
  ...
  if($text1 == "Unro" or $text1 == "UNRO" or $text1 == "unro" or $text1 == "/unro@Qitmirxonbot"){
 $gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($text1 == "pin" or $text1 == "Pin" or $text1 == "/pin" or $text1 == "/pin@Qitmirxonbot" or $text1 == "piN" or $text1 == "pIN" or $text1 == "pIn" or $text1 == "pIN"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if((stripos($mtext,"Sw")!==false) and $fadmin == $admin){
 ...
 if($text1 == "Del" or $text1 == "/del" or $text1== "del" or  $text1 == "/del@Qitmirxonbot"){
   bot('deleteMessage', [
    'chat_id'=>$chat_id,
    'message_id'=>$mesid
  ]);
 ...
 if($text1 == "ban" or $text1 == "Ban" or $text1== "/ban@Qitmirxonbot" or  $text1 == "/ban"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($get =="administrator" or $get == "creator"){
 ...
 if($text1 == "Unban" or $text1 == "/unban" or $text1== "/unban@Qitmirxonbot" or  $text1 == "unban"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($get =="administrator" or $get == "creator"){
 ...
 if($text1 == "Warn" or $text1 == "warn" or $text1== "/warn@Qitmirxonbot" or  $text1 == "/warn"){
  $gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
bot('sendChatAction',['chat_id'=>$chat_id,'action'=>"typing"]);
 ...
 if($text1 == "Unwarn" or $text1 == "unwarn" or $text1== "/unwarn@Qitmirxonbot" or  $text1 == "/unwarn"){
  $gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
