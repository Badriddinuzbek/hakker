...
error_reporting(0);
ob_start();
define('API_KEY',890325364:AAHAAqHHNAW4cHiibRnjefSvGJaBnow32gM '');
$admin = " 590445977"; 
$kanali = "@Xacker_net_n1";
...
[ 'inline_keyboard'=>[
                ...
                [['text'=>'✅Botga Kirish','url'=>'https://telegram.me/Valijonbot'],], 
               ] ],
...
'parse_mode'=>"markdown",
      'text'=>"😎* $name gruppamizdan chiqib ketdi
👥Qolgan a'zolar soni: $count*"
    ]);
}
// chiqib ketdi
...
if($chanel_video or $channel_audio or $channel_poto or $chanel_doc or $channel_text){
    ...
    bot('editMessageCaption',[
        'chat_id'=>$channel_id,
        'caption'=>"👇👉Bizga qo'shiling👈👇\n [🌐 @Faqat_dostlar_group ] ✅ \n 🆔 : [@Xacker_net_n1] \n 🆔 : [@Xacker_net_n1_134205579]",
        'message_id'=>$channel_mid,
        'parse_mode'=> 'Markdown',
        'reply_markup'=>json_encode([
            'inline_keyboard'=>[
                [['text'=>"🔵Postni yuborish↗", "url"=>"https://t.me/share/url?url=https://t.me/@Xacker_net_n1/@Xacker_net_n1_134205579]],
[['text'=>"⚪Do'stlarni chaqirish⬇", "url"=>"https://t.me/share/url?url=https://t.me/@Xacker_net_n1"]],
            ]
        ])
        ]);
}
...
//Yangi kod: @KILLING_BLOGGER 

if(($text1 == "/rasm" or $text1 == "/rasm@Valijonbot") and $fadmin==in_array($fadmin,$array)){
     $photo = bot("getUserProfilePhotos",[
    "user_id"=>$cid])->result->photos[0][0]->file_id;
    if(isset($photo)){
        $pto = $photo;
    }else{
        $pto = "617622346:AAGmLRsuhNqkSsxwPX4g2Za78392W5a2slY'  ";
    }
//
 bot('sendPhoto', [
    'chat_id'=>$chat_id,
    'photo'=>$pto,
        'caption'=>"*Sizning profilingizdagi rasmingiz!*",
        'parse_mode'=>"markdown",
 ]);
}

if($text1 == "/start" or $text1 == "/start@Valijonbot"){
$chm = file_get_contents("news.txt");
bot('forwardMessage', [
'chat_id'=>$chat_id,
'from_chat_id'=>$kanali,
  ...
  'reply_markup'=>json_encode([   
   'inline_keyboard'=>[   
       ...
       [['text'=>'🌟Yangiliklar','callback_data' => "uzim"],['text'=>'👨‍💻Admin','callback_data' => "a"]],
          [["switch_inline_query"=>"@", 'text' => "🆔Sinab korish"],['text'=>'🎮Foydali bolim','callback_data'=>"foydali"]],
[['text'=>'👥Guruhga qo‘shish','url'=>'telegram.me/KILLINGBOT?startgroup=new']]
]   
]),
]);
}
...
'reply_markup'=>json_encode([
'inline_keyboard' =>[
[['text'=>'15-20','callback_data'=>"yoshi 15-20"]],
[['text'=>'25-30','callback_data'=>"yoshi 25-30"]],
[['text'=>'30-35','callback_data'=>"yoshi 30-35"]],
]
]),
]);
  bot('sendmessage',[
    'chat_id'=>$admin,
    'text'=>"Yangi azo $callfname $calluname $data",
    ]);
}
...
*Mening ismim Killing do‘stlarim esa Killer deb chaqirishadi!\n\n🔹 Men guruhlarda gaplasha olaman va  guruh adminlari uchun qulay bo‘lgan  buyruqlar orqali guruhni boshqarishga ko‘maklashaman!*\n
📃*Men xuddi insonga o'xshayman guruhga qo'shsangiz ko'plab so'zlar yodlayman yana odam deb o'ylamang!*\n
*🆔Men yana inline rejimda kanal va gruppa haqida ma'lumot ham beraman sinab ko'rish tugmasi orqali tekshirib ko'rishingiz mumkin*\n\n🍁*Yangiliklar:* [@iGoldStatus]
👥*Guruhimiz:* [@Uz_BotsGroup]
🎓*Yaratuvchi:* [@KoderNet]",
'parse_mode' => 'markdown',
'disable_web_page_preview'=>true,
  'reply_markup'=>json_encode([   
   'inline_keyboard'=>[   
       ...
       [['text'=>'🌟Yangiliklar','callback_data' => "uzim"],['text'=>'👨‍💻Admin','callback_data' => "a"]],
          [["switch_inline_query"=>"@", 'text' => "🆔Sinab korish"],['text'=>'🎮Foydali bolim','callback_data'=>"foydali"]],
[['text'=>'👥Guruhga qo‘shish','url'=>'telegram.me/Valijonbot?startgroup=new']]
]   
]),
]);
  bot('sendmessage',[
    'chat_id'=>$admin,
    'text'=>"$callfname $calluname $data",
    ]);
}
...
[['text'=>'🔙Orqaga ','callback_data'=>"back"],['text'=>'♻Tarqatish↗','url'=>'http://telegram.me/share/url?url=https://t.me/Valijonbot']]
]
]),
]);
}
...
[['text'=>'⛅Termiz☁','callback_data'=>"ter"],['text'=>'📡KoderNet','url'=>'https://telegram.me/KoderNet']],
[['text'=>'🔙Orqaga','callback_data'=>"foydali"],['text'=>'♻Tarqatish↗','url'=>'http://telegram.me/share/url?url=https://t.me/Valijonbot']]
]
]),
]);
}
...
if($data=="back"){
   ...
   'chat_id'=>$chat_id2,
    'message_id'=>$message_id2,
'text'=> "⚜*Salom* [$first_name](tg://user?id=$chat_id2)
*Mening ismim Valijon do‘stlarim esa Viki deb chaqirishadi!\n\n🔹 Men guruhlarda gaplasha olaman va  guruh adminlari uchun qulay bo‘lgan  buyruqlar orqali guruhni boshqarishga ko‘maklashaman!*\n
📃*Men xuddi insonga o'xshayman guruhga qo'shsangiz ko'plab so'zlar yodlayman yana odam deb o'ylamang!*\n
*🆔Men yana inline rejimda kanal va gruppa haqida ma'lumot ham beraman sinab ko'rish tugmasi orqali tekshirib ko'rishingiz mumkin*\n\n🍁*Yangiliklar:* [@iGoldStatus]
👥*Guruhimiz:* [@Faqat_dostlar_group]
...
[['url' => 'https://telegram.me/Valijonbot?startgroup=new', 'text' => "Guruhga Qo‘shish"],],
]
]),
]);
}
...
['inline_keyboard' => [
[['text'=>'🔙Orqaga', 'callback_data' => "back"]],
[['url' => 'https://telegram.me/KILLINGBOT 
?startgroup=new', 'text' => "👥Guruhga Qo‘shish"],],
]
]),
]);
}
...
if($data=="a"){
   ...
   'chat_id'=>$chat_id2,
    'message_id'=>$message_id2,
    'text'=> "👮*Bot admini va reklama bo'yicha:* [KILLING_BLOGGER ](https://t.me/KILLING_BLOGGER )
🔰*Yangiliklar:* [Gold Status](https://t.me/Xacker_net_n1)

☎️ *Telefon:* +998 913580002\n\n
⏳ *Ish Vaqti:* 13:00 - 23:00\n\n
*Bot yasattirish uchun* [🔏KILLING_BLOGGER ](https://t.me/KILLING_BLOGGER ) *bilan narxlarni kelishib oling*",
    'parse_mode' => 'markdown',
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode(
['inline_keyboard' => [
 [['text'=>'👨‍💻 Admin','url'=>'https://telegram.me/KoderNet'],], 
 [['text'=>'🚫 Spamlar Uchun','url'=>'https://telegram.me/Sekret_Hackerbot'],], 
[['text'=>'🔙Orqaga', 'callback_data' => "back"]],
[['url' => 'https://telegram.me/KILLINGBOT ?startgroup=new', 'text' => "👥Guruhga Qo‘shish"],],
]
]),
]);
}
...
'reply_markup'=>json_encode(
['inline_keyboard' => [
[['text'=>'📬Buyurtma berish♻','url'=>"https://t.me/KoderNet"],], 
[['text'=>'📃Malumot','callback_data'=>"usermalumot"],['text'=>'🚔Bosh menu','callback_data'=> "back"]],
[['text'=>'🔙Orqaga','callback_data'=>"reklama"],['text'=>'Keyingi🔜','callback_data'=>"guruhuz"]]
]
]),
]);
}
...
'reply_markup'=>json_encode(
['inline_keyboard' => [
[['text'=>'📬Buyurtma berish♻','url'=>"https://t.me/KILLING_BLOGGER 0"],], 
[['text'=>'📃Malumot','callback_data'=>"usermalumot"],['text'=>'🚔Bosh menu','callback_data'=> "back"]],
[['text'=>'🔙Orqaga','callback_data'=>"reklama"],['text'=>'Keyingi🔜','callback_data'=>"guruhuz"]]
]
]),
...
if($data=="botlarimiz"){
   ...
   'chat_id'=>$chat_id2,
    'message_id'=>$message_id2,
    'text'=> "*Salom, biz yaratgan botlarimiz bilan tanishib chiqing. Sizlarga ham botlar kerak bo‘lsa, bizga murojaat qiling!*\n*Jamoamiz:* [@Php_Koderlar]",
'parse_mode' => 'markdown',
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode(
['inline_keyboard' => [
[['text'=>'🔀Konverter','url'=>'https://telegram.me/UzKonvertbot'],],
   [['text'=>'📡UZB RekN1','url'=>'https://telegram.me/uzb_rekn1bot'],], 
    [['text'=>'😉Viki bot','url'=>'https://telegram.me/Valijonbot'],], 
...
if($text1 == "/buyruqlar" or $text1 == "/buyruqlar@ValijonBot"){
if($cty == "supergroup" or $cty == "group"){
  bot('sendChatAction',['chat_id'=>$chat_id,'action'=>"typing"]);
$bs = bot('sendMessage',[
'chat_id'=>$chat_id,
...
'chat_id'=>$chat_id, 
'reply_to_message_id'=>$mid,
'photo'=>"http://www.iloveheartstudio.com/-/p.php?t=$ex[1]%EE%BB%AE$ex[2]%20$ex[3]%0A$ex[4]%0D%0ABy%20%20@KoderNet&bc=000000&tc=ffffff&hc=FF0000&f=n&uc=true&ts=true&ff=PNG&w=500&ps=sq",
'caption'=>"by @KoderNet",
]);
}

$id = $update->message->from->id;
$get = file_get_contents("https://api.telegram.org/bot617622346:AAGl6v0DaRohTF7RgJuklykDF5hXjZEfAL0/getUserProfilePhotos?user_id=$id&limit=1");
$json = json_decode($get);
$photo = $json->result->photos[0][0]->file_id;

if(mb_stripos($mtext,"/rasm") !== false){ 
  bot('sendPhoto',[
       'chat_id'=>$chat_id,
        'photo'=>$photo,
        'parse_mode'=>'markdown',
...
👮<b>Bot admini:</b> <a href='tg://user?id=378569270'>KoderNet</a>", 
      ]);
   }
...
/// YANGI KOD
if($text1 == "/sozlamalar" or $text1 == "/sozlamalar@ValijonBot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
🌠Bu oy $buoy kundan iborat",
    ...
    if($text1 == "/admin" or $text == "/admin@Valijonbot"){
      bot('sendmessage',[
        'chat_id'=>$chat_id,
...
if($data1 == 'zar'){ 
$anb9 = file_get_contents('http://obhavo.uz/zarafshan'); 
$ex1=explode("\n",$anb9);
...
if((stripos($mtext,"KILLING_BLOGGER ") !== false) or (stripos($mtext,"KILLING_BLOGGER ")!==false) or (stripos($mtext,"koder")!==false)){
  $name = $message->from->first_name;
...
if((stripos($mtext,"Valijon") !== false) or (stripos($mtext,"Viki") !== false) or (stripos($mtext,"Bolakay") !== false) or (stripos($mtext,"viki")!==false)){
...
if((stripos($mtext,"Status")!==false) or (stripos($mtext,"status")!== false)){
  $input = array("😐Voy status esdan chiqti","Yaxshi status yupkaga oxshashi kere etiborni tortadigan darajada kaltaligi bilan @KoderNet","Bu dunyoda dardingni hatto qalamga ham aytma srazi borib qogozga sotadi @KoderNet","Qiziq a... 
Inson yerga yiqilsa kulamiz
Iphone yerga tushib ketsa achinamiz. @KoderNet","Kimdur manda qalesan ?
Axvollaring qale ?
Ishlaring joyidami ?
deb so'rashsa yuzimda tabassum bilan
Hammasi yaxshi hammasi joyida
deb javob beraman
Lekin kimdur kozlarimga qarab togrisini ayt deyishini xolardim @KoderNet","Yurak suyaksiz ammo eng kop sinadigan ham YURAKDIR @KoderNet","Dunyoda aytish qiyin bolgan eng uzun va qiyin beshta soz bor. Mana ular : 
1.Sinxrofazotron. 
2.Fenolftalein.
3.Dixlordifeniltrixloretan.
4.Tetragidrokannabinol. 
5. Eng qiyini va kopchilik talafuz qila olmaydigon soz bu KECHIRING @KoderNet","Dunyoda achchiq bomasa shirinni qadri yoq! @KoderNet","ALLOH AYTADI
Agar bandam menga bir qadam yursa men ikki qadam yuraman, Agar bandam mega qarab yurib kelsa men yugurib boraman. @KoderNet","AyriM InsonlanI YaqindaN BilganiM SarI ItlagA BogaN MexriM OshvottI @KoderNet","FuUuUu blin 
Ishi tushsa  typingI.L
Ishi tushmasa online @KILLING_BLOGGER ","Hayot yurak chizmasiga o'xshaydi, Agar bir tekkis chiziqaa aylansa bu sening o'lganingni anglatadi !!!...... @KILLING_BLOGGER ","Osmon musaffoligiga sabab u yerda odamlar yashamaydi... @KILLING_BLOGGER ","Qanotlaringga kuch yig'may turib Xayotda baland parvoz qilma! Chunki balanddan sho'ng'ishnin oqibati ayanchli.. @KILLING_BLOGGER ","Haqiqiy yigit sevgani haqida boshqalarga so'zlab bermaydi. @KILLING_BLOGGER );
  $rand=rand(0,30);
  $soz="$input[$rand]";
  $a=json_encode(bot('sendmessage',[
   'reply_to_message_id'=>$mesid,
...
if((mb_stripos($mtext,"/savol") !== false) or (mb_stripos($mtext,"Ahror")!==false) or (stripos($mtext,"Ахтамов")!==false) or (mb_stripos($mtext,"Shavkat")!==false) or (mb_stripos($mtext,"Шавкат")!==false)){ 
bot('SendMessage',[
'chat_id'=>$admin,
'parse_mode'=>'html',
...
if($text1 == "ro" or $text1 == "Ro" or $text1 == "RO" or $text1 == "/ro@Valijonbot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($get =="administrator" or $get == "creator"){
  ...
  bot('sendmessage', [
    ...
    if($text1 == "Kick"  or  $text1 == "kick"  or $text1 == "/kick" or $text1 == "/kick@Valijonbot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($get =="member"){
 ...
 if($text1 == "Addpm" or $text1 == "addpm" or $text1 == "/addpm@Valijonbot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($get =="administrator" or $get == "creator"){
  ...
  bot('sendmessage',[
   ...
   if($text1 == "Delpm" or $text1 == "delpm" or $text1 == "/delpm@Valijonbot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
bot('promoteChatMember',[
  ...
  if($text1 == "Unro" or $text1 == "UNRO" or $text1 == "unro" or $text1 == "/unro@Valijonbot"){
 $gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($text1 == "pin" or $text1 == "Pin" or $text1 == "/pin" or $text1 == "/pin@Valijonbot" or $text1 == "piN" or $text1 == "pIN" or $text1 == "pIn" or $text1 == "pIN"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if((stripos($mtext,"Sw")!==false) and $fadmin == $admin){
 ...
 if($text1 == "Leavechat" or $text1 == "/leavechat" or $text1== "leavechat" or  $text1 == "/leavechat@Valijonbot"){
  bot('sendmessage', [
      'chat_id' => $chat_id,
 ...
 if($text1 == "Del" or $text1 == "/del" or $text1== "del" or  $text1 == "/del@Valijonbot"){
   bot('deleteMessage', [
    'chat_id'=>$chat_id,
    'message_id'=>$mesid
  ]);
 ...
 if($text1 == "Unban" or $text1 == "/unban" or $text1== "/unban@Valijonbot" or  $text1 == "unban"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($get =="administrator" or $get == "creator"){
 ...
 if($text1 == "Warn" or $text1 == "warn" or $text1== "/warn@Valijonbot" or  $text1 == "/warn"){
  $gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
bot('sendChatAction',['chat_id'=>$chat_id,'action'=>"typing"]);
 ...
 if($text1 == "Unwarn" or $text1 == "unwarn" or $text1== "/unwarn@Valijonbot" or  $text1 == "/unwarn"){
  $gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
