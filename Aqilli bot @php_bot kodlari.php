...
$API_KEY = 'Bu yerga bot tokeni';
$kanalimz = "@Kanaliz useri":
$admin = "ID RAQAMIZ";
...
bot('sendMessage',[
    'chat_id'=>$chat_id,
    'text'=>"Shu hali aytganimizdak bu bot orqali zerikmayaizde deyarli lekin sizga bitta taklif bor kanalimizga qo'shilsangiz undan ham zerikmaysiz 💖",
    'parse_mode'=>'html',
   'reply_markup'=>json_encode([
      'inline_keyboard'=>[
	  	  [
	  ['text'=>"📣 Zeriktirmaydigan kanal 💖",'url'=>"http://telegram.me/$kanlimz"]
	  ]
		]
		])
  ]);
