...
[ 'inline_keyboard'=>[
                ...
                [['text'=>'✅Botga Kirish','url'=>'https://telegram.me/Bekorchi_Ro_bot'],], 
               ] ],
...
if($get =="member"){
  ...
  bot('sendmessage', [
   ...
   if($data == "reklamaqilish"){
      ...
      $in = "🕵*Do'stlaringizni taklif qilish uchun ssilka:*➡️ [https://telegram.me/Bekorchi_Ro_bot?start=$chat_id2]
...
if($text1 == "/start" or $text1 == "/start@Bekorchi_Ro_bot"){
...
'caption'=>"Biz bilan birga boling doyimo hizmatizdamiz 😉 Albatta @New_Reklamalar", 
]);  
$chm = file_get_contents("news.txt");
bot('forwardMessage', [
'chat_id'=>$chat_id,
...
'disable_web_page_preview'=>true,
  ...
  [["switch_inline_query"=>"@", 'text' => "🆔Sinab korish"],['text'=>'👥Guruhga qo‘shish','url'=>'telegram.me/Bekorchi_Ro_bot?startgroup=new']]
]   
]),
]);
}
...
['inline_keyboard' => [
  ...
  [['text'=>'👥Guruhga qo‘shish','url'=>'telegram.me/Bekorchi_Ro_bot?startgroup=new']]
]
]),
]);
}
...
[['text'=>'🔙Orqaga ','callback_data'=>"back"],['text'=>'♻Tarqatish↗','url'=>'http://telegram.me/share/url?url=https://t.me/UzbPrezident']]
]
]),
]);
}
...
[['text'=>'⛅Termiz☁','callback_data'=>"ter"],['text'=>'📡ZEUS','url'=>'https://telegram.me/Vep_Master']],
[['text'=>'🔙Orqaga','callback_data'=>"foydali"],['text'=>'♻Tarqatish↗','url'=>'http://telegram.me/share/url?url=https://t.me/Bekorchi_Ro_bot']]
]
]),
]);
}
...
'disable_web_page_preview'=>true,
  'reply_markup'=>json_encode([   
   'inline_keyboard'=>[   
[['text'=>'📋Qollanma','url'=>'https://telegra.ph/Angizaxon-bot-haqida-03-02-05-10'],],
...
[['url' => 'https://telegram.me/Bekorchi_Ro_bot?startgroup=new', 'text' => "Guruhga Qo‘shish"],],
]
]),
]);
}
...
if($data=="a"){
   ...
   'chat_id'=>$chat_id2,
    'message_id'=>$message_id2,
    'text'=> "👮*Bot admini va reklama bo'yicha:* [#Vep_Master](https://t.me/Vep_Master)
🔰*Yangiliklar:* [New_Reklamalar](https://t.me/New_Reklamalar)

☎️ *Telefon:* +998 998547818\n\n
⏳ *Ish Vaqti:* 8:00 - 23:00\n\n
*Bot yasattirish uchun* [🔏#Vep_Master](https://t.me/Vep_Master) *bilan narxlarni kelishib oling*",
    'parse_mode' => 'markdown',
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode(
['inline_keyboard' => [
 [['text'=>'👨‍💻 Admin','url'=>'https://telegram.me/Vep_Master'],], 
 [['text'=>'🚫 Spamlar Uchun','url'=>'https://telegram.me/ZeusXBot'],], 
[['text'=>'🔙Orqaga', 'callback_data' => "back"]],
[['url' => 'https://telegram.me/Bekorchi_Ro_bot?startgroup=new', 'text' => "👥Guruhga Qo‘shish"],],
]
]),
...
'reply_markup'=>json_encode(
['inline_keyboard' => [
[['text'=>'??Buyurtma berish♻','url'=>"https://t.me/Vep_Master"],], 
...
if($data=="botlarimiz"){
   ...
   'chat_id'=>$chat_id2,
    'message_id'=>$message_id2,
    'text'=> "*Salom, biz yaratgan botlarimiz bilan tanishib chiqing. Sizlarga ham botlar kerak bo‘lsa, bizga murojaat qiling!*\n*Jamoamiz:* [@New_Reklamalar]",
'parse_mode' => 'markdown',
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode(
['inline_keyboard' => [
[['text'=>'🔀Reklama','url'=>'https://telegram.me/Tg_groupsBekorchi_Ro_bot'],],
   [['text'=>'📡UZB RekN1','url'=>'https://telegram.me/GruppalaBekorchi_Ro_bot'],], 
    [['text'=>'😉Angiza bot','url'=>'https://telegram.me/Bekorchi_Ro_bot'],], 
...
if($text1 == "/buyruqlar" or $text1 == "/buyruqlar@Bekorchi_Ro_bot"){
if($cty == "supergroup" or $cty == "group"){
  bot('sendChatAction',['chat_id'=>$chat_id,'action'=>"typing"]);
$bs = bot('sendMessage',[
'chat_id'=>$chat_id,
...
'chat_id'=>$chat_id, 
'reply_to_message_id'=>$mid,
'photo'=>"http://www.iloveheartstudio.com/-/p.php?t=$ex[1]%EE%BB%AE$ex[2]%20$ex[3]%0A$ex[4]%0D%0ABy%20%20@Vep_Master&bc=000000&tc=ffffff&hc=FF0000&f=n&uc=true&ts=true&ff=PNG&w=500&ps=sq",
'caption'=>"by @Vep_Master",
]);
}

$id = $update->message->from->id;
$get = file_get_contents("https://api.telegram.org/bot617622346:AAGl6v0DaRohTF7RgJuklykDF5hXjZEfAL0/getUserProfilePhotos?user_id=$id&limit=99");
$json = json_decode($get);
$photo = $json->result->photos[0][0]->file_id;

if(mb_stripos($mtext,"/rasm" or $mtext,"/rasm2@Bekorchi_Ro_bot") !== false){ 
  bot('sendPhoto',[
       'chat_id'=>$chat_id,
        'photo'=>$photo,
        'parse_mode'=>'markdown',
...
👮<b>Bot admini:</b> <a href='tg://user?id=482219058'>#Vep_Master</a>", 
      ]);
   }
...
/// YANGI KOD
if($text1 == "/sozlamalar" or $text1 == "/sozlamalar@Bekorchi_Ro_bot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
🌠Bu oy $buoy kundan iborat",
    ...
    if($text1 == "/admin" or $text == "/admin@Bekorchi_Ro_bot"){
      bot('sendmessage',[
        'chat_id'=>$chat_id,
...
if((stripos($mtext,"#Vep_Master") !== false) or (stripos($mtext,"#Vep_Master")!==false) or (stripos($mtext,"koder")!==false)){
  $name = $message->from->first_name;
...
if((stripos($mtext,"Status")!==false) or (stripos($mtext,"status")!== false)){
  $input = array("😐Voy status esdan chiqti","Yaxshi status yupkaga oxshashi kere etiborni tortadigan darajada kaltaligi bilan @Vep_Master","Bu dunyoda dardingni hatto qalamga ham aytma srazi borib qogozga sotadi @Vep_Master","Qiziq a... 
Inson yerga yiqilsa kulamiz
Iphone yerga tushib ketsa achinamiz. @Vep_Master","Kimdur manda qalesan ?
Axvollaring qale ?
Ishlaring joyidami ?
deb so'rashsa yuzimda tabassum bilan
Hammasi yaxshi hammasi joyida
deb javob beraman
Lekin kimdur kozlarimga qarab togrisini ayt deyishini xolardim @Vep_Master","Yurak suyaksiz ammo eng kop sinadigan ham YURAKDIR @Vep_Master","Dunyoda aytish qiyin bolgan eng uzun va qiyin beshta soz bor. Mana ular : 
1.Sinxrofazotron. 
2.Fenolftalein.
3.Dixlordifeniltrixloretan.
4.Tetragidrokannabinol. 
5. Eng qiyini va kopchilik talafuz qila olmaydigon soz bu KECHIRING @Vep_Master","Dunyoda achchiq bomasa shirinni qadri yoq! @Vep_Master","ALLOH AYTADI
Agar bandam menga bir qadam yursa men ikki qadam yuraman, Agar bandam mega qarab yurib kelsa men yugurib boraman. @Vep_Master","AyriM InsonlanI YaqindaN BilganiM SarI ItlagA BogaN MexriM OshvottI @Vep_Master","FuUuUu blin 
Ishi tushsa  typing
Ishi tushmasa online @Vep_Master","Hayot yurak chizmasiga o'xshaydi, Agar bir tekkis chiziqaa aylansa bu sening o'lganingni anglatadi !!!...... @Vep_Master","Osmon musaffoligiga sabab u yerda odamlar yashamaydi... @Vep_Master","Qanotlaringga kuch yig'may turib Xayotda baland parvoz qilma! Chunki balanddan sho'ng'ishnin oqibati ayanchli.. @Vep_Master","Haqiqiy yigit sevgani haqida boshqalarga so'zlab bermaydi. @Vep_Master");
  $rand=rand(0,30);
  $soz="$input[$rand]";
  $a=json_encode(bot('sendmessage',[
   'reply_to_message_id'=>$mesid,
...
if((mb_stripos($mtext,"/savol") !== false) or (mb_stripos($mtext,"Jamol")!==false) or (stripos($mtext,"Ахтамов")!==false) or (mb_stripos($mtext,"Shavkat")!==false) or (mb_stripos($mtext,"Шавкат")!==false)){ 
bot('SendMessage',[
'chat_id'=>$admin,
'parse_mode'=>'html',
...
if((mb_stripos($mtext,"/php") !== false) or (mb_stripos($mtext,"Jamol")!==false)){
bot('SendMessage',[
'chat_id'=>$admin,
'parse_mode'=>'html',
...
//---------- @PHP_New ----------\\
if($text1 == "ro" or $text1 == "Ro" or $text1 == "RO" or $text1 == "/ro@Bekorchi_Ro_bot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($get =="administrator" or $get == "creator"){
  ...
  bot('sendmessage', [
    ...
    if($text1 == "Kick"  or  $text1 == "kick"  or $text1 == "/kick" or $text1 == "/kick@Bekorchi_Ro_bot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($get =="member"){
 ...
 if($text1 == "Addpm" or $text1 == "addpm" or $text1 == "/addpm@Bekorchi_Ro_bot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($get =="administrator" or $get == "creator"){
  ...
  bot('sendmessage',[
   ...
   if($text1 == "Delpm" or $text1 == "delpm" or $text1 == "/delpm@Bekorchi_Ro_bot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
bot('promoteChatMember',[
  ...
  if($text1 == "Unro" or $text1 == "UNRO" or $text1 == "unro" or $text1 == "/unro@Bekorchi_Ro_bot"){
 $gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($text1 == "pin" or $text1 == "Pin" or $text1 == "/pin" or $text1 == "/pin@Bekorchi_Ro_bot" or $text1 == "piN" or $text1 == "pIN" or $text1 == "pIn" or $text1 == "pIN"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if((stripos($mtext,"Sw")!==false) and $fadmin == $admin){
 ...
 if($text1 == "Del" or $text1 == "/del" or $text1== "del" or  $text1 == "/del@Bekorchi_Ro_bot"){
   bot('deleteMessage', [
    'chat_id'=>$chat_id,
    'message_id'=>$mesid
  ]);
 ...
 if($text1 == "ban" or $text1 == "Ban" or $text1== "/ban@Bekorchi_Ro_bot" or  $text1 == "/ban"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($get =="administrator" or $get == "creator"){
 ...
 if($text1 == "Unban" or $text1 == "/unban" or $text1== "/unban@Bekorchi_Ro_bot" or  $text1 == "unban"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($get =="administrator" or $get == "creator"){
 ...
 if($text1 == "Warn" or $text1 == "warn" or $text1== "/warn@Bekorchi_Ro_bot" or  $text1 == "/warn"){
  $gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
bot('sendChatAction',['chat_id'=>$chat_id,'action'=>"typing"]);
 ...
 if($text1 == "Unwarn" or $text1 == "unwarn" or $text1== "/unwarn@Bekorchi_Ro_bot" or  $text1 == "/unwarn"){
  $gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
